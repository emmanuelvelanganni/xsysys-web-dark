		...
		<div class="main">
			...
			<div class="xsysys_main_access_cntr" role="main">
				<div id="leadspacehead" class="lead_space_head page_space_head">
					<div class="xsysys_page_space_body historyBG">
							<div class="header">
								<span class="glyphicon glyphicon-th"></span>&nbsp;History
							</div>
							<div class="session">
								<h1><span class="glyphicon glyphicon-hand-right"></span>&nbsp;Know our history to know</h1>
								<h2>Your Bright Future</h2>
							</div>
					</div>
				</div>
					...
					<div class="content pagecontent">
						<div class="xsysys_container_body">
							<div class="session_page">
								...
								<p>
									The parent company DeDuCo is a leading Belgium-based, but globally expanding company with a rich history in developing and implementing Customer Relationship Management software solutions.
								</p>
								<p>
									After its foundation in 1987 DeDuCo grew into a major player with outstanding expertise in four selected market sectors: the Consumer Goods sector (Food and Nonfood), the Pharmaceutical OTC sector, the Hotel and Catering sector and the Vending machines sector.
								</p>
								<p>
									DeDuCo offers its customers company-wide software solutions and a wide range of related services. Its CRM software suite contains five integrated products (KEYaccount+, SALESforce+, SECtor+, CALLcenter+ and FIELDservice+), all of them ensuring the customers’ competitive edge. For more information, please visit <a href="www.deduco.com">www.deduco.com</a>
								</p>
