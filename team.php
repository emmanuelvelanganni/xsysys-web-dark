		...
		<div class="main">
			...
			<div class="xsysys_main_access_cntr" role="main">
				<div id="leadspacehead" class="lead_space_head page_space_head">
					<div class="xsysys_page_space_body teamBG">
							<div class="header">
								<span class="glyphicon glyphicon-th"></span>&nbsp;Team
							</div>
							<div class="session">
								<h1><span class="glyphicon glyphicon-hand-right"></span>&nbsp;Indo-European Management Team</h1>
								<h2>Valuing People Effort</h2>
							</div>
					</div>
				</div>
					...
					<div class="content pagecontent">
						<div class="xsysys_container_body">
							<div class="session_page">
								<h1>Team</h1>
								<p>
									Day by day our Indo-European management team inspires an exceptional group of people delivering an unsurpassed level of service ensuring competitive edge for our clients. Innovative solutions based on the latest trends in information technology will allow our clients to leverage on the effects of globalization helping them to achieve their expected business results.
									We strongly believe in human endeavour as a supreme value without which nothing worth while can be achieved in life. Do you recognize any of the six attributes listed below?
								</p>
									<table class="page_table">
										<tr>
											<td>FORTITUDE</td>
											<td>do you have the mental strength to lead the technology revolution?</td>
										</tr>	
										<tr>
											<td>WISDOM </td>
											<td>do you have the wisdom to take the right decisions time and again?</td>
										</tr>
										<tr>
											<td>STRENGTH </td>
											<td>do you have the strength to start all over again day after day?</td>
										</tr>
										<tr>
											<td>VALOUR</td>
											<td>do you have the quality of spirit that enables you to face real danger?</td>
										</tr>
										<tr>
											<td>EFFORT</td>
											<td>do you have the energy to put the extra effort and make the difference?</td>
										</tr>
										<tr>
											<td>DARING</td>
											<td>are you daring enough to continuously take up the challenge?</td>
										</tr>
									</table>
									<em>We always look out for inspiring leaders subscribing to human endeavour</em><br/><br/>
