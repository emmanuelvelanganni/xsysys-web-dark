			...
			<div class="xsysys_main_access_cntr" role="main">
				<div id="leadspacehead" class="lead_space_head page_space_head news">
					<div class="xsysys_page_space_body news newsBG">
							...
							<div class="session">
								<h1><span class="glyphicon glyphicon-hand-right"></span>&nbsp;<span class="xsysys_style">xsysys</span> NEWS</h1>
							</div>
					</div>
				</div>
							...
							<div class="session_page">
								...
								<script>
									function load_internalnews(){
										$("#session_body").unload("pressreleases.php");
										$("#session_body").unload("presscoverage.php");
										$("#session_body").load("internalnews.php");
									}
									function load_pressreleases(){
										$("#session_body").unload("internalnews.php");
										$("#session_body").unload("presscoverage.php");
										$("#session_body").load("pressreleases.php");
									}
									function load_presscoverage(){
										$("#session_body").unload("internalnews.php");
										$("#session_body").unload("pressreleases.php");
										$("#session_body").load("presscoverage.php");
									}
								</script>
							</div>
						</div>
