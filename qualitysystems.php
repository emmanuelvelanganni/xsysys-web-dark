		...
		<div class="main">
			...
			<div class="xsysys_main_access_cntr" role="main">
				<div id="leadspacehead" class="lead_space_head page_space_head">
					<div class="xsysys_page_space_body qualitysystemsBG">
							<div class="header">
								<span class="glyphicon glyphicon-th"></span>&nbsp;Quality Systems
							</div>
							<div class="session">
								<h1><span class="glyphicon glyphicon-hand-right"></span>&nbsp;Our Quality Culture is founded on a</h1>
								<h2>Well Evolved Software Quality <br/> Assurance (SQA) Mechanism.</h2>
							</div>
					</div>
				</div>
					...
					<div class="content pagecontent">
						<div class="xsysys_container_body">
							<div class="session_page">
								<h1>Gateway</h1>
								<p>
									The quality systems at <span class="xsysys_style">xsysys</span> match the best in the world. We benchmark ourselves against international quality standards, like ISO 9001, SEI CMM and 6 Sigma. The quality culture at xsysys is founded on a well evolved Software Quality Assurance (SQA) mechanism. Our Quality Assurance (QA) team ensures our ability to commit to and constantly deliver, superior quality solutions that revolve around these quality systems and methodologies.
								</p>
								<p>
									Achieving and delivering the highest levels of excellence is our ultimate corporate goal, it forms an essential part of our corporate DNA structure. We set the standards for leadership and quality and bring these standards to our clients; they form the foundation in our business relationship with them.
								</p>
								<p>Our Software Quality Assurance System has the following benefits:</p>
								<ul>
