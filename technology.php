		...
		<div class="main">
			...
			<div class="xsysys_main_access_cntr" role="main">
				<div id="leadspacehead" class="lead_space_head page_space_head">
					<div class="xsysys_page_space_body technologyBG">
							<div class="header">
								<span class="glyphicon glyphicon-th"></span>&nbsp;Technology
							</div>
							<div class="session">
								<h1><span class="glyphicon glyphicon-hand-right"></span>&nbsp;Technology Leadership</h1>
								<h2>To Deliver Technology Driven Solutions</h2>
							</div>
					</div>
				</div>
					...
					<div class="content pagecontent">
						<div class="xsysys_container_body">
							<div class="session_page">
								<h1>Technology</h1>
								<p>
									Technology leadership is a critical driver for hi-tech companies. New market entrants rely on technology leadership to build significantly differentiated products and services that can challenge incumbent players. At the same time, the incumbents rely on R&D to consolidate their leadership positions. Successful strategies in this race focus on technology innovation to engineer new products and services.
								</p>
								<p>
									At any given moment in time customers need a differentiating factor in the way technology is applied for their specific need. As technology is changing at rates never seen before, it requires constant focus and creativity to stay ahead and be ready to surf the next technology wave.
								</p>
								<p>
									At <span class="xsysys_style">xsysys</span> Technologies we understood the need for a high level Alliances Program as well as a relentless focus on evolving customer needs. Because of the program that we recently started, we are able to focus on delivering world class customer specific technology driven solutions.
								</p>
								<p>
									If you want to know more about our Alliances Program you can send us an e-mail at <a href="mailto:alliances@xsysys.com" style="text-decoration:none;">alliances@<span class="xsysys_style">xsysys</span>.com</a> or click on <a href="#" style="text-decoration:none;">alliances</a>
								</p>
